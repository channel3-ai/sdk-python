...
__all__ = ["SearchPerformResponse", "SearchPerformResponseItem", "SearchPerformResponseItemImage"]


class SearchPerformResponseItemImage(BaseModel):
    url: str
...
class SearchPerformResponseItem(BaseModel):
    ...
    images: Optional[List[SearchPerformResponseItemImage]] = None
