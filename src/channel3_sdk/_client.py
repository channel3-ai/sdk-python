...
if TYPE_CHECKING:
    from .resources import brands, search, products, websites, reporting, categories, conversations, price_tracking
...
class Channel3(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        custom_headers_env = os.environ.get("CHANNEL3_CUSTOM_HEADERS")
