...
```sh
# install from this staging repo
pip install 'public_sdk[aiohttp] @ git+ssh://git@github.com/stainless-sdks/public-sdk-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/public-sdk-python/tree/main/src/public_sdk/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/public-sdk-python/tree/main/src/public_sdk/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
