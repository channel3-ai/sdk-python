...
from channel3_sdk.types.reporting import Click
...
class TestClicks:
    ...
    def test_method_list(self, client: Channel3) -> None:
        click = client.reporting.clicks.list()
    ...
    def test_raw_response_list(self, client: Channel3) -> None:
        response = client.reporting.clicks.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Channel3) -> None:
        with client.reporting.clicks.with_streaming_response.list() as response:
...
class TestAsyncClicks:
    ...
    async def test_method_list(self, async_client: AsyncChannel3) -> None:
        click = await async_client.reporting.clicks.list()
    ...
    async def test_raw_response_list(self, async_client: AsyncChannel3) -> None:
        response = await async_client.reporting.clicks.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncChannel3) -> None:
        async with async_client.reporting.clicks.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
