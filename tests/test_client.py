...
class TestChannel3:
    ...
    def test_hardcoded_query_params_in_url(self, client: Channel3) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: Channel3) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: Channel3) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
...
class TestAsyncChannel3:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncChannel3) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncChannel3) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
